...
const Register: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      <form onSubmit={handleRegister} className="bg-white/80 backdrop-blur-lg p-10 rounded-2xl shadow-xl w-full max-w-md border border-blue-200">
        ...
        <button type="submit" className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-3 rounded-lg font-bold text-lg shadow-md hover:from-blue-600 hover:to-purple-600 transition">Register</button>
